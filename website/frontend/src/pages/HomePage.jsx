    ...
    <>
      ...
      <section className="page-hero relative overflow-hidden" aria-labelledby="hero-heading">
        ...
        <div className="page-hero-grid">
          <div>
            ...
            <h1 id="hero-heading" className="text-display mt-2 text-3xl leading-[1.08] font-semibold text-navy sm:mt-3 sm:text-4xl md:text-5xl lg:mt-4 lg:text-6xl xl:text-7xl">
              <TextReveal text="ONE FIRM EVERY IP SOLUTION" />
            </h1>
            <FadeIn delay={0.3}>
              <p className="mt-3 max-w-lg text-base leading-relaxed text-muted sm:mt-4 md:mt-5 lg:mt-6 md:text-lg">
            ...
            <FadeIn delay={0.4}>
              <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:gap-4 md:mt-6 lg:mt-8">
      ...
      <section className="page-section bg-surface" aria-labelledby="practice-heading">
        <div className="container-custom">
          ...
          <FadeIn delay={0.15} className="mt-8 md:mt-12">
            <Swiper
          ...
          <FadeIn className="mt-8 text-center md:mt-12">
      ...
      <section className="page-section" aria-labelledby="why-heading">
        <div className="container-custom grid items-center gap-8 lg:grid-cols-2 lg:gap-16">
      ...
      <section className="page-section" aria-labelledby="industry-heading">
        <div className="container-custom">
          ...
          <StaggerContainer className="mt-8 grid gap-5 sm:grid-cols-2 sm:gap-6 lg:grid-cols-3 md:mt-12">
            {industries.map((ind) => (
      ...
      <section className="page-section bg-surface" aria-labelledby="testimonials-heading">
        <div className="container-custom">
          ...
          <Swiper
            ...
            pagination={{ clickable: true }}
            className="mt-8 !pb-10 md:mt-12 md:!pb-12"
          >
            {testimonials.map((t) => (
      ...
      <section className="page-section" aria-labelledby="team-heading">
        <div className="container-custom">
          ...
          <StaggerContainer className="mt-8 grid gap-6 sm:grid-cols-2 sm:gap-8 lg:grid-cols-4 md:mt-12">
      ...
      <section className="page-section bg-surface" aria-labelledby="blog-heading">
        <div className="container-custom">
          ...
          <div className="mt-8 grid gap-5 sm:grid-cols-2 sm:gap-6 lg:grid-cols-3 md:mt-12">
