  ...
  return (
    <div
      className={cn(
        ...
        scrolled ? 'bg-white/95 py-2 shadow-soft backdrop-blur-md lg:py-3' : 'bg-transparent py-3 lg:py-5',
      )}
    >
      <div className="container-custom flex items-center justify-between">
        <Link to="/" className="flex items-center gap-3" aria-label={`${brandAriaLabel()} home`}>
          <img src="/logo.png" alt="" className="h-11 w-11 shrink-0 rounded-full object-cover shadow-md sm:h-12 sm:w-12 lg:h-16 lg:w-16" width={64} height={64} />
