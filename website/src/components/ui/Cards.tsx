...
export function TeamCard({ name, role, expertise, className }: TeamCardProps) {
  return (
    <motion.article
...
export function CTABanner({ title, description, buttonText = 'Schedule Consultation', buttonHref = '/contact' }: CTABannerProps) {
  return (
